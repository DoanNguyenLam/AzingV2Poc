...
public class EmailPortletActionImpl extends DefaultConfigurationAction {
    ...
    public void processAction(PortletConfig portletConfig, ActionRequest actionRequest, ActionResponse actionResponse) throws Exception {
        ...
        String promptSummary = ParamUtil.getString(actionRequest, PROMPT_SUMMARY);
        String promptSuggestion = ParamUtil.getString(actionRequest, PROMPT_SUGGESTION);
        ...
        setPreference(actionRequest, PROMPT_SUMMARY, promptSummary);
        setPreference(actionRequest, PROMPT_SUGGESTION, promptSuggestion);
        ...
        _log.info("PROMPT_SUMMARY: {}", promptSummary);
        _log.info("PROMPT_SUGGESTION: {}", promptSuggestion);
